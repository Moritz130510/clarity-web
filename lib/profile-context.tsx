...
export function ProfileProvider({ children }: { children: ReactNode }) {
  ...
  // SCHEMA (verified):
  //   community_profiles.clarity_id  = auth.users.id   (TEXT, often UPPERCASE)
  //   community_profiles.id          = separate UUID (the FK for created_by / profile_id / author_id)
  // Therefore the lookup MUST be case-insensitive on clarity_id.
  const loadProfile = useCallback(async (authUser: User): Promise<Profile | null> => {
    ...
    // No row yet — create one. Use uppercase clarity_id to match iOS convention.
